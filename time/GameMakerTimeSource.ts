...
function gamemaker_timesource_get_children(parameters = {}) {
    ...
    for (let i = 0; i < _.length; i++) {
        _children.push(new TimeSourceGeneric({ time_source_id : _children_ids[i] }))
    }
    return _children
}
...
class TimeSourceGeneric {
    ...
    this.get_id                    = method(this, get_id)
    this.create                    = method(this, create)
    this.exists                    = method(this, exists)
    this.destroy                   = method(this, destroy)
    this.start                     = method(this, start)
    this.pause                     = method(this, pause)
    this.stop                      = method(this, stop)
    this.is_stopped                = method(this, is_stopped)
    this.resume                    = method(this, resume)
    this.reconfigure               = method(this, reconfigure)
    this.reset                     = method(this, reset)
    this.get_children              = method(this, get_children)
    this.get_parent                = method(this, get_parent)
    this.get_period                = method(this, get_period)
    this.get_state                 = method(this, get_state)
    this.get_remaining_time        = method(this, get_remaining_time)
    this.get_units                 = method(this, get_units)
    this.get_completed_repetitions = method(this, get_completed_repetitions)
    this.get_remaining_repetitions = method(this, get_remaining_repetitions)
    this.get_repetitions           = method(this, get_repetitions)
    this.get_expiry_type           = method(this, get_expiry_type)
    this.get_callback              = method(this, get_callback)
    this.get_arguments             = method(this, get_arguments)
