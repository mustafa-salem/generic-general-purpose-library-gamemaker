...
function gamemaker_sprite_draw(arguments) {
    ...
    static draw_method_shader = function(arguments) {
        ...
        if (arguments.nine_slice) {
            gamemaker_sprite_draw.draw_method_nine_slice(arguments)
        } else if (arguments.tiled) {
            gamemaker_sprite_draw.draw_method_tiled(arguments)
        } else {
            gamemaker_sprite_draw.draw_method_default(arguments)
        }
    ...
    if (parameters.shader != -1) {
        draw_method_shader(parameters)
    } else if (parameters.nine_slice) {
        draw_method_nine_slice(parameters)
    } else if (parameters.tiled) {
        draw_method_tiled(parameters)
    } else {
        draw_method_default(parameters)
    }
}

class GameMakerSprite {
...
class GameMakerSpriteInstance {

}

// REFERS TO SPRITE ASSET
class GameMakerSpriteSpritePattern {
