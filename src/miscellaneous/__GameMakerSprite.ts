...
function scr_draw_sprite_crop(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7) {
    ...
    var _leftcrop = Interpolation.clamp((argument2 - _true_xanchor), 0, Math.abs(_sprite_width))
    var _topcrop = Interpolation.clamp((argument3 - _true_yanchor), 0, Math.abs(_sprite_height))
    var _rightcrop = Interpolation.clamp((argument4 - _true_xanchor), 0, Math.abs(_sprite_width))
    var _bottomcrop = Interpolation.clamp((argument5 - _true_yanchor), 0, Math.abs(_sprite_height))
