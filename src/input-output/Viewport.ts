...
export class Viewport {
    ...
    public get_camera(parameters = {}) {
        var _view_port_index = Viewport.get_index({ view_port : parameters.view_port })
    ...
    /// The view port to target or its index (0 - 7).
    /// @returns {Struct}
    public get_position(parameters = {}) {
        var _view_port_index = Viewport.get_index({ view_port : parameters.view_port })
        return {
    ...
    public get_x_dimension(parameters = {}) {
        var _view_port_index = Viewport.get_index({ view_port : parameters.view_port })
    ...
    public get_x_position(parameters = {}) {
        var _view_port_index = Viewport.get_index({ view_port : parameters.view_port })
    ...
    /// The view port to target or its index (0 - 7).
    /// @returns {Real}
    public get_y_dimension(parameters = {}) {
        var _view_port_index = Viewport.get_index({ view_port : parameters.view_port })
    ...
    /// The view port to target or its index (0 - 7).
    /// @returns {type}
    public get_y_position(parameters = {}) {
        var _view_port_index = Viewport.get_index({ view_port : parameters.view_port })
    ...
    public set_dimensions(parameters = {}) {
        var _view_port_index = Viewport.get_index({ view_port : parameters.view_port })
    ...
    /// @param {Type} parameters.parameter_name
    public set_position(parameters = {}) {
        var _view_port_index = Viewport.get_index({ view_port : parameters.view_port })
        if (parameters["x"] != undefined) {
    ...
    public set_x_dimension(parameters = {}) {
        var _view_port_index = Viewport.get_index({ view_port : parameters.view_port })
    ...
    /// @param {Type} parameters.parameter_name
    /// <parameter_description>
    public set_x_position(parameters = {}) {
        var _view_port_index = Viewport.get_index({ view_port : parameters.view_port })
    ...
    /// @param {Type} parameters.parameter_name
    /// <parameter_description>
    public set_y_dimension(parameters = {}) {
        var _view_port_index = Viewport.get_index({ view_port : parameters.view_port })
    ...
    /// @param {Type} parameters.parameter_name
    /// <parameter_description>
    public set_y_position(parameters = {}) {
        var _view_port_index = Viewport.get_index({ view_port : parameters.view_port })
...
/*     if (parameters == undefined) {
    ...
    public get position() {
        return Viewport.get_x_position(parameters)
        return Viewport.get_y_position(parameters)
        return Viewport.get_position(parameters)
    }

    public set position(position: Vector2) {
        Viewport.set_x_position(parameters)
        Viewport.set_y_position(parameters)
    }

    public set position(position: Vector2) {
        Viewport.set_position(parameters)
    }
