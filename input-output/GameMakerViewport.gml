...
/// @param {Struct.ViewPortGeneric|Real} parameters.view_port
...
/// @param {Struct.ViewPortGeneric|Real} parameters.view_port
/// The view port to target or its index (0 - 7).
/// @param {Struct.CameraGeneric|Real|Undefined} parameters.camera
...
function ViewPortGeneric {
    ...
    static get_visible = function(parameters = {}) {
        ...
        if (_is_instance_scope) { parameters.view_port = self }
    ...
    /// @returns {Struct.CameraGeneric|Undefined}
    static get_camera = function(parameters = {}) {
        var _is_instance_scope = is_instanceof(self, ViewPortGeneric)
        if (_is_instance_scope) { parameters.view_port = self }
        return gamemaker_viewport_get_camera(parameters)
    }
    ...
    /// @param {Type} parameters.parameter_name
    /// @returns {type}
    static set_x_position = function(parameters = {}) {
        var _is_instance_scope = is_instanceof(self, ViewPortGeneric)
        if (_is_instance_scope) { parameters.view_port = self }
    ...
    /// @param {Type} parameters.parameter_name
    /// @returns {type}
    static set_y_position = function(parameters = {}) {
        var _is_instance_scope = is_instanceof(self, ViewPortGeneric)
        if (_is_instance_scope) { parameters.view_port = self }
    ...
    /// @returns {type}
    static get_position = function(parameters = {}) {
        var _is_instance_scope = is_instanceof(self, ViewPortGeneric)
        if (_is_instance_scope) { parameters.view_port = self }
